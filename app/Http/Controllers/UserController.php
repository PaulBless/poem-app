...
class UserController extends Controller
{
    ...
    public function updateProfileInformation(Request $request)
    {
        ...
        return $this->user->updateProfileInformation($email,$name,$headline,$about_me,$address,$phone_number);
    ...
    public function updateProfilePic(Request $request)
    {
        ...
        return (new ResponseHelper(false, 'Validation Error', 400, "Error While Adding Image"))->get();
