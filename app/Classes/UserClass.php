...
class UserClass
{
    ...
    public function updateProfileInformation($email,$name,$headline,$about_me,$address,$phone_number){
        ...
        try {
            ...
            $update_status = $this->userManager->updateProfileInformation($email,$name,$headline,$about_me,$address,$phone_number);
            if ($update_status){
                return response()->json(['status' => true, 'message' => 'profile information updated successfully'])->setStatusCode(200);
            }
